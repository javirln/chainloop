...
func (gu *GroupUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if gu.mutation.MembersCleared() {
		...
		createE := &GroupUserCreate{config: gu.config, mutation: newGroupUserMutation(gu.config, OpCreate)}
		createE.defaults()
...
func (guo *GroupUpdateOne) sqlSave(ctx context.Context) (_node *Group, err error) {
	...
	if guo.mutation.MembersCleared() {
		...
		createE := &GroupUserCreate{config: guo.config, mutation: newGroupUserMutation(guo.config, OpCreate)}
		createE.defaults()
		_, specE := createE.createSpec()
		edge.Target.Fields = specE.Fields
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
