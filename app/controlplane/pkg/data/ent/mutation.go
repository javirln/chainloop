...
func (m *GroupUserMutation) SetMaintainer(b bool) {
	m.maintainer = &b
}

// Maintainer returns the value of the "maintainer" field in the mutation.
func (m *GroupUserMutation) Maintainer() (r bool, exists bool) {
	v := m.maintainer
	if v == nil {
		return
	}
...
func (m *GroupUserMutation) ResetMaintainer() {
	m.maintainer = nil
}
...
func (m *GroupUserMutation) ClearUser() {
	m.cleareduser = true
	m.clearedFields[groupuser.FieldUserID] = struct{}{}
}
...
func (m *GroupUserMutation) Fields() []string {
	...
	if m.maintainer != nil {
		fields = append(fields, groupuser.FieldMaintainer)
	}
	if m.created_at != nil {
...
func (m *GroupUserMutation) Field(name string) (ent.Value, bool) {
	...
	case groupuser.FieldUserID:
		return m.UserID()
	case groupuser.FieldMaintainer:
		return m.Maintainer()
