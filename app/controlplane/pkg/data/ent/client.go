...
func (c *Client) Use(hooks ...Hook) {
	for _, n := range []interface{ Use(...Hook) }{
		c.APIToken, c.Attestation, c.CASBackend, c.CASMapping, c.Group, c.GroupUser,
		c.Integration, c.IntegrationAttachment, c.Membership, c.OrgInvitation,
		c.Organization, c.Project, c.ProjectVersion, c.Referrer, c.RobotAccount,
...
type (
	hooks struct {
		APIToken, Attestation, CASBackend, CASMapping, Group, GroupUser, Integration,
