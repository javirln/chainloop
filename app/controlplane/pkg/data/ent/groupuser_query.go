...
func (guq *GroupUserQuery) ForUpdate(opts ...sql.LockOption) *GroupUserQuery {
...
func (guq *GroupUserQuery) ForShare(opts ...sql.LockOption) *GroupUserQuery {
	if guq.driver.Dialect() == dialect.Postgres {
		guq.Unique(false)
	}
	guq.modifiers = append(guq.modifiers, func(s *sql.Selector) {
...
func (guq *GroupUserQuery) Modify(modifiers ...func(s *sql.Selector)) *GroupUserSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (gus *GroupUserSelect) Modify(modifiers ...func(s *sql.Selector)) *GroupUserSelect {
